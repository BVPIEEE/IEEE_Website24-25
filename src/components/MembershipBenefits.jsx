  ...
  return (
    <div className="p-4 md:p-10 py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-black mb-4">Why Choose Us?</h2>
        <h3 className="text-2xl font-semibold text-center text-blue mb-12">Membership Benefits</h3>
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="p-6">
                ...
                <h4 className="text-xl font-semibold text-gray-800 mb-2 text-center">{benefit.title}</h4>
