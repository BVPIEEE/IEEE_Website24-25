...
const TeamMember = ({name, role, image, linkedinUrl}) => {
  ...
  return (
    <div className="font-poppins relative h-36 md:h-48 group" data-aos="fade-up">
      ...
      <h3 className="text-md md:text-lg text-sky-200 text-center">{name}</h3>
      <p className="text-lg md:text-xl text-white font-semibold text-center">{role}</p>
...
const Sig = ({ chaptername, execoms, grid }) => {
  return (
